...
/*   Updated: 2021/03/22 13:11:49 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	Span s7(20);
	TEST_EXCEPTION(s7.shortestSpan(), Span::ConteinerHasOnlyOneElementException, "There isn't enough numbers in this Span to calculate spans");
	TEST_EXCEPTION(s7.longestSpan(), Span::ConteinerHasOnlyOneElementException, "There isn't enough numbers in this Span to calculate spans");

	out("Span | Functions on span with one element");
	Span s8(20);
	s8.addNumber(0);
	TEST_EXCEPTION(s8.shortestSpan(), Span::ConteinerHasOnlyOneElementException, "There isn't enough numbers in this Span to calculate spans");
	TEST_EXCEPTION(s8.longestSpan(), Span::ConteinerHasOnlyOneElementException, "There isn't enough numbers in this Span to calculate spans");
	...
	s9.addNumber(0);
	s9.addNumber(0);
	TEST_EXCEPTION(s9.addNumber(0), Span::StorageIsFullException, "This Span is full, you can't add any more numbers to it");
	...
	Span s11(1000);
	s11.addNumber(v1.begin(), v1.end());
	s11.addNumber(v2.begin(), v2.end());
	check(s11.shortestSpan() == 1);
	check(s11.longestSpan() == 999);

	out("Span | illegal addRange");
	TEST_EXCEPTION(s11.addNumber(v2.begin(), v2.end()), Span::StorageIsFullException, "This Span is full, you can't add any more numbers to it");
	
	Span s12(500);
	TEST_EXCEPTION(s12.addNumber(v.begin(), v.end()), Span::StorageIsFullException, "This Span is full, you can't add any more numbers to it");
