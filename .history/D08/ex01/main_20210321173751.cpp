...
/*   Updated: 2021/03/21 17:37:51 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	Span s11(1000);
	s11.addNumbers(v1.begin(), v1.end());
	s11.addNumbers(v2.begin(), v2.end());
	check(s11.shortestSpan() == 1);
	check(s11.longestSpan() == 999);

	out("Span | illegal addRange");
	TEST_EXCEPTION(s11.addNumbers(v2.begin(), v2.end()), Span::SpanFull, "This Span is full, you can't add any more numbers to it");

	Span s12(500);
	TEST_EXCEPTION(s12.addNumbers(v.begin(), v.end()), Span::SpanFull, "This Span is full, you can't add any more numbers to it");
	...
	Span s13(1000);
	s13.addNumbers(d1.begin(), d1.end());
