...
/*   Updated: 2021/03/09 15:37:21 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void cdTest()
{
    ...
    Bureaucrat c(a);
    std::cout << c << std::endl; 
    std::cout << CLGREEN << "Creating a Form Visa with the grade 100: " << CLEND << std::endl;
    Bureaucrat a("Anna", 100);
    std::cout << a << std::endl;
    std::cout << CLGREEN << "Creating Anna's copy Bureaucrat: " << CLEND << std::endl;
    Bureaucrat c(a);
...
int main()
{
    ...
    std::cout << CLGREEN << "***" << CLEND << std::endl;
    std::cout << CLBLUE << "*** CONSTRUCTOR-DESTRUCTOR TEST STARTED ****" << CLEND << std::endl;
    cdTest();
    std::cout << CLBLUE << "//// CONSTRUCTOR-DESTRUCTOR TEST END ////" << CLEND << std::endl;
    return 0;
}