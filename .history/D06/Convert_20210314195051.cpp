...
/*   Updated: 2021/03/14 19:50:51 by dbliss           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Convert::Convert(char *input) : _input(input), _input2(input)
{
	parser();
}
...
void Convert::parser()
{
	convert_to_double();
	convert_to_float();
	if (this->_input2 == "nan" || this->_input2 == "nanf" || this->_input2 == "-inff" || this->_input2 == "+inff" || this->_input2 == "-inf" || this->_input2 == "+inf")
	{
